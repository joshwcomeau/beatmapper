...
> You can tweak the default duration of obstacles—as in, the length of brand-new obstacles—by pressing `O` and entering a new value. For example, if you want to add a bunch of short walls, you can press `O` and enter `0.5`
