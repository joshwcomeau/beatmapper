...
## Preparing your song and cover art
...
For cover art, the image you select needs to be square, with dimensions of at least 250x250 (I generally aim for at least 600x600, to ensure it looks sharp on any display).
...
![Google image search for the song title](googleSearchImgSrc)
...
<img src={googleSearchImgSrc} alt="searching on Unsplash" />
