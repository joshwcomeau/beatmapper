...
<ShortcutTable>
  ...
  >
    Change default obstacle duration
    <Sidenote>
      Brand-new obstacles will be 4 beats long, but you can change that default
      value so that shorter or longer obstacles are created. Pressing{' '}
      <code>O</code> will prompt you for a new value.
    </Sidenote>
  </Shortcut>
</ShortcutTable>
