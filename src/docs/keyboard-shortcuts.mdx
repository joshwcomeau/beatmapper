...
<ShortcutTable>
  ...
  >
    ...
    <Sidenote>
      Sometimes, you'll want to shift the selection forwards or backwards a bit. By holding <code><OptionKey /></code> and using the arrow keys or spinning the mousewheel, you can nudge notes. <strong>Respects the snapping interval</strong>.
    </Sidenote>
  </Shortcut>
